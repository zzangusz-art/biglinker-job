...
def build_seo_tags(title, description, slug):
    ...
    tags.append('  <meta property="og:image"       content="https://job.gobiglinker.com/assets/og-image.png">')
    ...
    tags.append('  <meta name="twitter:image"       content="https://job.gobiglinker.com/assets/og-image.png">')
...
def build_jsonld(title, description, slug, main_block):
    ...
    org = {
        ...
        "url": _DOMAIN,
        "logo": {"@type": "ImageObject", "url": "https://job.gobiglinker.com/assets/og-image.png"},
